# Include .env contents - No need for souce .env all the time
-include .env
...
deploy-sepolia:
	forge script script/DeployFunding.s.sol:DeployFunding --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
